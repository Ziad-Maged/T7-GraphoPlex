...
public class SubtractionVertex extends ComputationalVertex {

    public SubtractionVertex(ComputationalVertex a, ComputationalVertex b) {
        super();
        this.inputs.add(a);
        this.inputs.add(b);
    }
    ...
    public void computeGradient(double gradient) {
        inputs.get(0).computeGradient(gradient);
        inputs.get(1).computeGradient(-gradient);
    }
}
