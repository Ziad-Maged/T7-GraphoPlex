...
/**
 * Protobuf type {@code createIndexRequest}
 */
public final class createIndexRequest extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:createIndexRequest)
...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return Index.internal_static_createIndexRequest_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return Index.internal_static_createIndexRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            createIndexRequest.class, Builder.class);
  }
  ...
  public static createIndexRequest parseFrom(
  ...
  public static createIndexRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static createIndexRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static createIndexRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(createIndexRequest prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:createIndexRequest)
      createIndexRequestOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return Index.internal_static_createIndexRequest_descriptor;
    ...
    // Construct using com.server.graph_db.grpc.index.createIndexRequest.newBuilder()
    private Builder() {
    ...
    public createIndexRequest build() {
      createIndexRequest result = buildPartial();
    ...
    public createIndexRequest buildPartial() {
      createIndexRequest result = new createIndexRequest(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof createIndexRequest) {
    ...
    public Builder mergeFrom(createIndexRequest other) {
      if (other == createIndexRequest.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      createIndexRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (createIndexRequest) e.getUnfinishedMessage();
  ...
  private static final createIndexRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new createIndexRequest();
  }
