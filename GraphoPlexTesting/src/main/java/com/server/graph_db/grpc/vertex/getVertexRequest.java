...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return Vertex.internal_static_getVertexRequest_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return Vertex.internal_static_getVertexRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            getVertexRequest.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof getVertexRequest)) {
      return super.equals(obj);
    }
    getVertexRequest other = (getVertexRequest) obj;
  ...
  public static getVertexRequest parseFrom(
  ...
  public static getVertexRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static getVertexRequest parseFrom(
  ...
  public static getVertexRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static getVertexRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static getVertexRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(getVertexRequest prototype) {
  ...
  public static final class Builder extends
    ...
    @Override
    public getVertexRequest getDefaultInstanceForType() {
      return getVertexRequest.getDefaultInstance();
    }

    @Override
    public getVertexRequest build() {
      getVertexRequest result = buildPartial();
    ...
    @Override
    public getVertexRequest buildPartial() {
      getVertexRequest result = new getVertexRequest(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof getVertexRequest) {
        return mergeFrom((getVertexRequest)other);
      } else {
    ...
    public Builder mergeFrom(getVertexRequest other) {
      if (other == getVertexRequest.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      getVertexRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (getVertexRequest) e.getUnfinishedMessage();
  ...
  private static final getVertexRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new getVertexRequest();
  }

  public static getVertexRequest getDefaultInstance() {
